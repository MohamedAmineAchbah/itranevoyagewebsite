...
const Desti = () => {
  ...
  <div className="container  pb-24  ">
    <div className="text-center  mb-20">
      <h1 className="font-semibold mt-16 h-24  font-sans text-3xl leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-red-600 sm:text-5xl md:mx-auto mb-4">Nous voyageons vers toutes les destinations !</h1>
      <p className="text-base leading-relaxed xl:w-2/4 flex justify-center items-center  w-screen lg:w-3/4 mx-auto">Nos bus circulent dans toutes les gares routières du Maroc, de Tanger à Boujdour !</p>
    </div>
