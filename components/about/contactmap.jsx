...
const ContactMap = () => {
  ...
  <div className="absolute inset-0 bg-gray-300">
    <iframe width="100%" height="100%" frameBorder="0" marginHeight="0" marginWidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?q=Itrane%20Voyages%20-%20%D8%A3%D8%B3%D9%81%D8%A7%D8%B1%20%D8%A5%D8%AB%D8%B1%D8%A7%D9%86&t=&z=13&ie=UTF8&iwloc=&output=embed" ></iframe>
  </div>
  <div className="container px-5 py-24 mx-auto flex">
    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
      <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contactez nous</h2>
      <p className="leading-relaxed mb-5 text-gray-600">Partagez vos idées avec nous !</p>
      ...
      <button className="text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg">Envoyer</button>
      <p className="text-xs text-gray-500 mt-3">Vos informations personnelles ne seront pas partagées avec d'autres parties.</p>
    </div>
  </div>
</section>
    </div>
