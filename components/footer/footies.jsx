...
const Footies = () => {
    ...
    <div className=" flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full py-8 px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-red-700">Contact</a>
          </li>
      ...
      <div className="lg:w-1/4 md:w-1/2 py-8 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">+212 6 35776846</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">itranevoyage@gmail.com</a>
          </li>
      ...
      <div className="lg:w-1/4 md:w-1/2 py-8 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">Envoyer</button>
        </div>
  ...
  <div className="bg-gradient-to-br from-yellow-400 to-red-500 backdrop-blur-4xl shadow-2xl">
    <div className="container mx-auto flex items-center sm:flex-row flex-col">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
        <Image src='/logo2.png' height='80' width='120' alt='logo' >
        </Image>
        <span className="ml-3 text-xl">Itrane Voyage</span>
      </a>
      <p className="text-sm text-gray-100 sm:ml-6 sm:mt-0 mt-4">© 2022 Itrane —
