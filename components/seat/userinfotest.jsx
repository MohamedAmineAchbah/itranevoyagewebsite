        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-2xl  font-medium leading-6 text-gray-900">Informations de facturation </h3>
              <p className="mt-1 pt-3 pr-12 text-sm text-gray-600">
              Vous recevrez votre ticket par e-mail ou par téléphone.
              </p>
            </div>
          </div>
              ...
              <htmlForm action="#" method="POST">
                <div className="border border-orange-300 shadow overflow-hidden sm:rounded-md">
                  <div className="px-4 py-5 bg-slate-100  sm:p-6">
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input  type="text" name="name" id="name" value={user.first_name} onChange={e => setUser({ ...user, first_name: e.target.value })} autoComplete="given-name" className="mt-1 p-2 focus:ring-indigo-500 border focus:border focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-red-100 rounded-md" required />
                      </div>

                      <div className="col-span-6 sm:col-span-3">
                        <label htmlFor="last_name" className="block text-sm font-medium text-gray-700">Nom de famille</label>
                        <input required type="text" name="last_name" id="last_name" autoComplete="family-name" className="mt-1 p-2 focus:ring-red-500 border focus:border-red-500 block w-full shadow-sm sm:text-sm border-red-100 rounded-md" value={user.last_name} onChange={e => setUser({ ...user, last_name: e.target.value })} />
                      </div>

                      <div className="col-span-6 sm:col-span-3">
                        <label htmlFor="email_address" className="block text-sm font-medium text-gray-700">Adresse Email</label>
                        <input required type="email" name="email_address" id="email_address" value={user.email}
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input required type="tel" name="phone" id="phone" autoComplete="tel" placeholder=""
                          value={user.phone}
                      ...
                      <div className="col-span-6">
                        <label htmlFor="street_address" className="block text-sm font-medium text-gray-700">Adresse</label>
                        <input required type="text" name="street_address" id="street_address" value={user.address1}
                      ...
                      <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                        <label htmlFor="zip" className="block text-sm font-medium text-gray-700">Code postale</label>
                        <input required type="number" name="zip" id="zip" autoComplete="postal-code"
                          value={user.zip}
                  ...
                  <div className="px-4 py-3 mt-4 bg-gray-50 text-right sm:px-6">{adminLoggedIn ? <div>
                    <button type='submit' className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={() => {
                      handleConfirmTicket("admin");
                    }}>Confirmer en tant q'admin</button>
