...
export default function PaymentComponent({ handleConfirmTicket, formRef }) {
  ...
  return (
    <div className='flex justify-end content-center gap-5 text-left'>
      ...
      >Payer par carte bancaire</button>
            ...
            <div className="flex justify-center content-center gap-10">
              ...
              <div className="pr-4 pl-4 pb-4">
                ...
                <div className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8">
                  <h3 className="text-xl font-medium text-gray-900">Veuillez entrer les données de votre carte</h3>
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Numéro de la carte</label>
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Date d'expiration</label>
