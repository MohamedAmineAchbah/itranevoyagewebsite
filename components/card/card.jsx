...
const Card = () => {
  ...
  <div className="mb-15 mx-auto md:items-center flex flex-wrap">
    ...
    <div className="flex flex-col flex-wrap  mb-10 lg:w-5/5  lg:text-left text-center">
      ...
      <div className="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div className="flex-grow">
          <h2 className="text-gray-900 text-2xl title-font font-medium mb-3">Choisissez une date pour votre voyage</h2>
