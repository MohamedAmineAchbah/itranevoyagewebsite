...
const Features = () => {
  ...
  <div className="container  px-5 py-12 mb-12 mx-auto">
    <div className="hover:rounded-md hover:shadow-md py-12 text-center mb-14">
      <h1 className="mb-6 pt-12 text-center h-40 mt-6  font-sans text-3xl font-bold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-yellow-500 to-red-600 sm:text-5xl md:mx-aut">Réservez votre billet de chez vous pour le prix le plus bas !</h1>
